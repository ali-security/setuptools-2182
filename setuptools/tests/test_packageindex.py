...
class TestPackageIndex:
    ...
    def test_download_url_prevents_path_traversal(self, tmpdir):
        """
        Test that _download_url prevents path traversal attacks.
        CVE-2025-47273
        """
        index = setuptools.package_index.PackageIndex()
        ...
        with pytest.raises(ValueError, match="Invalid filename"):
            index._download_url('https', url, str(tmpdir))
        ...
        result = index._download_url('https', url, str(tmpdir))
        assert result == str(tmpdir / 'setuptools-78.1.0.tar.gz')
